  ...
  try
  {
    ...
    data = persons.map((person) =>
    {
      ...
      return {
        ...
        email: person.email,
        jobs: jobs.map((job) => ({
          jobInternalId: job.jobInternalId  || null,
          clinicCode: job.clinic.code || null,
          abbr: job.clinic.abbr?.trim() || null,
          sectionName: job.section.name || null,
          sectionCode: job.section.code || null,
          premisesName: job.premises?.name || null,
          jobTitle: job.jobPosition?.name || null,
          jobReferenceNumber: job.jobPosition?.referenceNumber || null,
          phoneExtension: job.phoneExtension || null,
